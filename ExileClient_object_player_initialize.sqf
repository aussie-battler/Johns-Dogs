...
// Dogs
player addAction ["Tame animal", "tameDog.sqf",true,0,false,true,"","Local player && vehicle player == player && cursorObject isKindOf 'Animal' && (_target distance cursorObject) < 4"];
